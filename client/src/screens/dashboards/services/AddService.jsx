    ...
    <Modal show={show} onHide={onHide}>
      ...
      <Formik
        ...
        onSubmit={(values) => {
          ...
          const days = daysOptions.map((d) => values.days.includes(d)).reverse();
          const daysBinary = days.reduce((res, x) => (res << 1) | x);
        ...
        {({ errors, values, setErrors, setFieldValue, handleSubmit }) => (
          <Form noValidation onSubmit={handleSubmit}>
            <Modal.Body>
              ...
              <CheckBoxOptions label="Days" options={daysOptions} name="days" />
              <Row>
                <Col xs={12} sm={6}>
                  <TextField
                    name="nameOfIncharge"
